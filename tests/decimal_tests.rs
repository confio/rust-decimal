...
mod maths {
    ...
    fn test_powd() {
        let test_cases = &[
            ...
            (
                "1234.5678",
                "0.9012",
                either!("611.04510428561357675577986291", "611.04510415448740041442807964"),
            ),
            (
                "-2",
                "0.5",
            ...
            (
                "0.0000000000000000000000000001",
                "0.1234567890123456789012345678",
                either!("0.000353364278686109712204183", "0.0003305188683169079961720764"),
            ),
        ];
        for &(x, y, expected) in test_cases {
            let x = Decimal::from_str(x).unwrap();
    ...
    fn test_exp() {
        ...
        let test_cases = &[
            ...
            ("10", "22026.464036258916624015414634"),
            // e^11 ~= 59874.14171519778
            ("11", "59874.106418696577517313682274"),
            // e^3 ~= 20.085536923187664
            ("3", "20.085536911963143539758560764"),
            // e^8 ~= 2980.957987041727
            ("8", "2980.9579854410334406623833785"),
    ...
    fn test_exp_with_tolerance() {
        let test_cases = &[
            // e^0 = 1
            ("0", "0.0002", "1"),
            // e^1 ~= 2.7182539682539682539682539681
            ("1", "0.0002", "2.7182539682539682539682539683"),
            // e^10 ~= 22026.465794806703
            ("10", "0.02", "22026.460266271287808109770781"),
            // e^11 ~= 59874.14171519778
            ("11", "0.0002", "59874.106418696577517313682274"),
            // e^11.7578 ~= 127741.03548949540892948423052
            ("11.7578", "0.0002", "127745.81431908268452024482964"),
            // e^3 ~= 20.085536923187664
            ("3", "0.00002", "20.085534430970814899386327955"),
            // e^8 ~= 2980.957987041727
            ("8", "0.0002", "2980.9579632726949323840240319"),
            // e^0.1 ~= 1.1051709180756477
            ("0.1", "0.0002", "1.1051666666666666666666666667"),
            // e^2.0 ~= 7.3890560989306495
            ("2.0", "0.0002", "7.3890460157126823793490460157"),
            // e^11.7578+ starts to overflow
            ("11.7579", "0.0002", "127758.58949071385271280217195"),
            // e^11.7578+ starts to overflow
            ("123", "0.0002", ""),
            ...
            ("-11", "0.0002", "0.0000167017106360978637072478"),
            // e^11.7579 has underflowed (by overflowing)
            ("-11.7579", "0.0002", "0.0000078272623702744081346163"),
        ...
        for &(x, tolerance, expected) in test_cases {
            ...
            if let Some(expected) = expected {
                ...
                assert_eq!(None, x.checked_exp_with_tolerance(tolerance), "e^{}", x);
            }
        }
    }
